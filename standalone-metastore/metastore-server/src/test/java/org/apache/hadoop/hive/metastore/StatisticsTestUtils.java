...
public class StatisticsTestUtils {
   ...
   */
  public static ColumnStatistics createColStats(ColumnStatisticsData data, String stats,
      Table tbl, FieldSchema column, String partName) {
    ColumnStatisticsObj statObj = new ColumnStatisticsObj(column.getName(), column.getType(), data, stats);
